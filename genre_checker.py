# A List of Every Genre on MusicBrainz
# I think there no other way to do this but if there Is I'll Scream
# Also Want to add some Extra Tags for Vocaluoal or Rythem Game OST
Genre = [
    "2 tone",
    "2-step",
    "3-step",
